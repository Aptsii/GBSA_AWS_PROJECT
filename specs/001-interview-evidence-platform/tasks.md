...
- [ ] T216 CRITICAL Lane C — Replace the ACK-only SQLAlchemy WebSocket handler with versioned session start, question, transcript/finalize, checkpoint, resume, degraded and completion orchestration using only Lane C repositories and public contracts per FR-023-FR-036 and QG-08 (missing)
