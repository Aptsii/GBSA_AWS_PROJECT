...
- [ ] T217 CRITICAL Integration — Add a safe local company principal/bootstrap fixture and executable Compose browser journey configuration without weakening stage/prod authentication under `backend/src/interview_evidence/main.py`, `compose.yaml` and `tests/e2e/` per FR-001-FR-052 and QG-01/QG-11 (missing)
