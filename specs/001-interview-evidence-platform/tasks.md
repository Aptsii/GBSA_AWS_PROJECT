...
- [ ] T215 CRITICAL Lane C — Replace placeholder recording upload URLs with the shared signed PUT contract and verify uploaded chunks into contiguous durable recording state under `backend/src/interview_evidence/interview_engine/`, including reconnect sequence tests per FR-027-FR-029 and QG-08 (missing)
